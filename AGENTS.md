...
- Treat `npm install`, `npm exec`, `npx`, `pnpm add`, `pnpm dlx`, `pip install`, and remote-script commands as proposals requiring package and source verification.
...
- Autonomous agents should produce reviewed commits/PRs; deployment must remain a separate controlled step.
